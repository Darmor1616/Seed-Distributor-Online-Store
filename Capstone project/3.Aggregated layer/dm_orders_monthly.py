...
target = spark.sql(f'''
          select date_format(date_trunc('MONTH', deliveryDate),'yyyy-MMM') as ReportingPeriod, count(1) as Orders_Number
          from fct_orders o
          where o.deliveryDate between '{beg_date}' and '{exp_date}'
